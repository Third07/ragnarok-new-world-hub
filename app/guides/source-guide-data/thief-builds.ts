...
export const guide = {
  ...
  "description": "Compare Dual Dagger, Critical Katar, and Venom Assassin builds in RTNW with stats, core traits, poison counters, cards, ASPD, and PvE choices.",
  ...
  "heroImage": "/assets/guides/thief-builds/thief-hero.webp",
  ...
  "quickFacts": [
    ...
    ["PVE recommendation", "Dual Dagger for flexible boss damage"],
  ...
  "sections": [
    ...
    },
    {
      ...
      "table": {
        "headers": ["Build", "Recommended stats", "Strength", "Limitation"],
        "rows": [
      ...
      "image": {
        "src": "/assets/guides/thief-builds/assassin-builds.webp",
        "alt": "Assassin build overview comparing Dual Dagger, Katar, and Venom",
        "caption": "Dual Dagger, Katar, and Venom demand different weapons and trait packages, so finish one route first."
      }
    },
    {
      "id": "traits",
      ...
      "bullets": [
        ...
        "For dungeon farming, move five Enhanced Hiding points to Enchant Poison on Dual Dagger so attacks can trigger poison and Poison Master."
      ],
      "image": {
        "src": "/assets/guides/thief-builds/enchant-poison.webp",
        "alt": "Enchant Poison skill details for a Dual Dagger Assassin"
      }
    },
    {
      "id": "element",
      ...
      "paragraphs": [
        "Poison counters Earth, Fire, Water, and Wind. Poison is in turn countered by Poison, Holy, Shadow, and Undead targets.",
      ...
      "image": {
        "src": "/assets/guides/thief-builds/fatal-stab.webp",
        "alt": "Assassin using Fatal Stab in combat"
      }
    },
    {
      "id": "progression",
      ...
      "steps": [
        {"title": "Lv.1–40", "text": "Use dual daggers. Early weapon traits have limited second-job value; Piamette can provide a useful 5% ASPD bonus."},
      ...
      "image": {
        "src": "/assets/guides/thief-builds/doppelganger-card.webp",
        "alt": "Doppelganger card details for an attack-speed Assassin build"
      }
    },
    {
      "id": "pve",
      "title": "Best general PVE choice",
      "paragraphs": [
        ...
        "Several five-player and ten-player bosses use Undead or Shadow attributes and heavily reduce poison damage. For a simple boss loop, weave Fatal Stab between normal attacks."
      ]
    }
  ],
  "faqs": [
    {"question": "Which Assassin build is best for PVE in RTNW?", "answer": "Dual Dagger reaches high ASPD more easily, uses Fatal Stab for sustained damage, and can switch between neutral and poison attacks."},
    ...
    {"question": "Why is Venom weaker against some bosses?", "answer": "Poison damage is resisted by Poison, Holy, Shadow, and Undead targets, and several current dungeon bosses fall into resistant categories."},

...
export const guide = {
  "slug": "guild-league",
  "title": "Ragnarok: The New World Guild League Guide",
  "seoTitle": "RTNW Guild League Guide: Schedule, Tiers & GVG Strategy",
  "description": "Learn the Ragnarok: The New World Guild League schedule, eight-tier promotion system, Main and Sub Battlefield roles, command skills, rewards, and GVG tactics.",
  ...
  "keywords": [
    ...
    "RTNW Guild League schedule",
    "RTNW GVG guide",
    "Guild League tiers",
    "Guild League rewards"
  ],
  "quickFacts": [
    ["Registration", "Monday 05:00 to Tuesday 16:00"],
    ["Battles", "Tuesday 21:30 and 22:00; Thursday 22:00 final"],
    ["Main Battlefield", "Up to 60 appointed vanguards"],
    ["Battle length", "22 minutes"],
    ["Tier count", "8 tiers, 8 guilds per tier"],
    ["Promotion", "Top 2 move up; bottom 2 move down"]
  ],
  "sections": [
    {
      "id": "schedule",
      ...
      "table": {
        ...
        "rows": [
          ["Registration", "Monday 05:00 – Tuesday 16:00", "Confirm participation, assign commanders, and prepare the 60-player main roster."],
          ["Preliminary", "Tuesday 21:30", "Establish lane assignments and test resource flow from the Sub Battlefield."],
    ...
    {
      "id": "tiers",
      "title": "Eight tiers, promotion, and rewards",
      "paragraphs": [
        "Guild League contains eight divisions: Fearless Rookie, Hopeful Apprentice, Rising Hero, Vanguard Elite, Strategic Commander, Transcendent Master, Glorious King, and Supreme Champion. Each tier holds eight guilds, with stronger rewards at higher ranks.",
        "At the end of the round, the top two guilds in a tier are promoted and the bottom two are demoted. Initial placement when the league opens is based on Guild Power ranking."
      ],
      "bullets": [
      ...
      "note": "Check the in-game Guild League → Rewards panel for the current season. Reward pools and item availability can change."
    },
    {
      "id": "battlefields",
      "title": "Main Battlefield and Sub Battlefield roles",
      "paragraphs": [
        "The event is won by coordinating two connected battlefields. The Main Battlefield is the visible 60-versus-60 GVG fight, while the Sub Battlefield supplies resources, buffs, command skills, and tower support.",
        "The Main Battlefield uses a three-lane MOBA-style map. Each lane has outer, middle, and high-ground towers leading to the enemy crystal. Destroying the crystal ends the match immediately; otherwise the result is decided by the remaining battlefield state."
      ],
      "table": {
        "headers": ["Area", "Primary job", "Who should be there"],
        "rows": [
          ["Main Battlefield", "Fight enemy vanguards, pressure towers, control lanes, and threaten the crystal.", "Balanced frontline, supports, ranged damage, assassins, and mobile flank groups."],
    ...
    {
      "id": "lineup",
      "title": "How to build the 60-player lineup",
      "paragraphs": [
        "Do not select the Main Battlefield roster by power ranking alone. A high-power group without tanks, healing, ranged pressure, and flank control can lose to a lower-power but better-organized guild.",
        "Keep enough capable players in the Sub Battlefield to contest enemy gatherers and protect your own resource flow."
      ],
      "bullets": [
        "Frontline: tanks and supports who can hold space and keep the main formation alive.",
        "Backline: Archers, Mages, and Gunslingers for sustained pressure and safer tower damage.",
    ...
    {
      "id": "strategy",
      "title": "Offense, defense, and comeback strategy",
      "steps": [
        {"title": "Identify the real win condition", "text": "Against a much weaker guild, a direct mid push can end the match. Against an equal opponent, protect crystal HP and towers while creating side-lane advantages."},
        {"title": "Use side lanes when mid is stalled", "text": "Abandon an unproductive central fight long enough to trade one tower for one or two weaker side structures."},
  ...
  "related": [
    ["Guild event schedule", "/sea/events/"],

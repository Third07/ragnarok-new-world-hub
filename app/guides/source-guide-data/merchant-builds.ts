...
export const guide = {
  ...
  "heroImage": "https://cdnimages.awselbcombine.com/public_images/one_image/2026/07/178401268368545315.png",
  "heroAlt": "Ragnarok: The New World Merchant character in Prontera",
  "sourceUrl": "https://forum.gnjoy.hk/forum/index.html?gameId=456&id=roseaforum#/post/101181",
  "sourceTitle": "Merchant 2nd Job Guide: Master Merchant Builds in 3 Minutes",
  ...
  "quickFacts": [
    ...
    ["Recommended pet", "Piamette in the supplied guide"],
  ...
  "sections": [
    ...
    },
    {
      ...
      "table": {
        "headers": ["Build", "Damage pattern", "Core traits from the source", "Best fit"],
        "rows": [
    ...
    },
    {
      ...
      "paragraphs": [
        "STR is the core stat. The supplied guide recommends roughly 70–90 STR and then VIT; Axe Throwing and Turret players can add LUK when Critical contributes to their setup.",
    ...
    },
    {
      ...
      "steps": [
        ...
        {"title": "Lv.55–69: prepare for advanced second job", "text": "Farm boss gear, materials, and cards. The source favors Water–Fire resonance for damage because Merchant has difficulty reaching 193 ASPD, and recommends damage increase and STR on Relics."}
      ]
    },
    {
      "id": "cards",
    ...
    },
    {
      ...
      "paragraphs": [
        "Axe Throwing and Turret are the supplied guide's main dungeon recommendations. Their burst is lower than some pure damage classes, but their sustained output is stable once the second-job traits are complete.",
  ...
  "faqs": [
    {"question": "What is the best Merchant stat in RTNW?", "answer": "STR is the primary stat in the supplied guide, generally raised to about 70–90 before adding more VIT. Axe Throwing and Turret setups may add LUK for Critical."},
    ...
    {"question": "Which Merchant build is best for PVE bosses?", "answer": "The source recommends Axe Throwing or Turret for stable dungeon damage, with Weapon Perfection adding valuable party-wide size correction."},
    {"question": "Why should I fill the Cart early?", "answer": "Cart skill damage scales with Cart weight. The supplied guide says damage can more than double after weight exceeds 5,000."}
  ],
  "related": [

...
const STATIC_PAGES: SearchResult[] = [
  ...
  { id: "creator-kit", title: "RTNW Creator Asset Library", description: "Search and download skill, card, weapon, equipment, monster, pet, map, and interface images with lightweight loading.", href: "/creator-kit/", icon: "/icon-192.png", fallback: "C" },
  ...
  { id: "redfinger-guide", title: "Redfinger Cloud Phone Guide", description: "Universal Android, iPhone, Windows, Mac and browser setup, trials, plans, lag fixes and Ragnarok: The New World compatibility checks.", href: "/guides/redfinger-cloud-phone/", icon: "/media/images/zhujiemian/icon_zhujiemian_tianqixingchen.webp", fallback: "R" },

...
const STATIC_PAGES: SearchResult[] = [
  ...
  { id: "creator-kit", title: "RTNW Creator Kit", description: "Download RTNW Hub logos, build cards, YouTube thumbnail templates, and video overlays with clear creator-use rules.", href: "/creator-kit/", icon: "/icon-192.png", fallback: "C" },

...
const STATIC_PAGES: SearchResult[] = [
  ...
  { id: "creator-kit", title: "RTNW Creator Asset Library", description: "Search and download skill, card, weapon, equipment, monster, pet, and map images plus RTNW Hub thumbnail templates.", href: "/creator-kit/", icon: "/icon-192.png", fallback: "C" },

# Redfinger guide maintenance

Route: `/guides/redfinger-cloud-phone/`
...
Extracted from the owner-provided Redfinger MHTML snapshot, dated 2026-08-28. Credit remains with Redfinger; these are promotional illustrations, not screenshots of RTNW testing. Only the two relevant PNG images were extracted for use. No saved scripts, styles, contacts, tracking data or other snapshot resources were imported.

| Asset family | Original source | Original dimensions |
| --- | --- | --- |
| `redfinger-devices` | https://www.cloudemulator.net/upload/Home/feature-1.png | 602 × 631 |
| `redfinger-session` | https://www.cloudemulator.net/upload/Home/feature-3.png | 600 × 602 |

Each is encoded locally as WebP at its original width and at 360 px. Keep the original aspect ratio, explicit dimensions, responsive `srcSet` and below-fold lazy loading. Image sitemap entries point to the full-width WebP files.

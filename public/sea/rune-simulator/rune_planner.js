        ...
        if (a) {
            ...
            s.innerHTML = `
                <button type="button" class="rune-loadout-slot" aria-label="Edit rune slot ${n + 1}">
                    ...
                    <span class="rune-loadout-slot-icon">${r ? `<img loading="lazy" decoding="async" src="${r}" alt="">` : '<span class="rune-slot-icon-placeholder"></span>'}</span>
                ...
                <div class="rune-loadout-card">
                    <button type="button" class="rune-loadout-card-main" aria-label="Edit ${escapeHtml(e ? e.name : `rune slot ${n + 1}`)}">
                        <span class="rune-loadout-card-icon">${r ? `<img loading="lazy" decoding="async" src="${r}" alt="">` : '<span class="rune-slot-icon-placeholder"></span>'}</span>
